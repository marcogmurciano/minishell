...
/*   Updated: 2025/06/25 18:29:03 by dbarba-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv, char **envp)
{
	...
	while (1)
	{
		...
		if(minishell.input)
		{
			...
			minishell.expanded_input = expand_tokens_list(minishell.tokens_list);
			minishell.tokens_list = tokenizer(minishell.expanded_input);
		}
		else
