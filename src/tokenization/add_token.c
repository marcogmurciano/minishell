...
/*   Updated: 2025/07/14 17:08:11 by dbarba-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * Creates a new token of the specified type using create_nonword_token() and appends it
 * to the end of the linked list pointed to by token_head.
 *
 ...
 * 
 * Creates a new token of the specified type, word, and quote using create_word_token()
 ...
 * 
 * Creates a new EOF token using create_eof_token() and appends it to the end of the
 * linked list pointed to by token_head.
 *
 * @param token_head Pointer to the head pointer of the token list.
 * @return 0 on success, -1 on allocation failure.
 */
