...
/*   Updated: 2025/07/14 17:07:51 by dbarba-v         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 *
 * Allocates memory for a token, assigns the given token type and duplicated word,
 * sets the quote type based on the provided character, and returns a pointer to the new token.
 * Returns NULL if allocation fails.
 *
 * @param t_type The type of token to create.
 * @param word The string value for the token (will be duplicated).
 * @param quote The quote character type: '\0' for none, '\'' for single, '\"' for double.
 * @return Pointer to the newly created token, or NULL on failure.
 */
